(function(window, document) {
  function init() {
    ...
    function keepUpdated() {
      var playButton = document.querySelector('#cboxContent .timeline_playpause.playing')
      var pauseButton = document.querySelector('#cboxContent .timeline_playpause.paused')
      while(!playButton) {
        pauseButton.dispatchEvent(click)
        playButton = document.querySelector('#cboxContent .timeline_playpause.playing')
      }
    }
    function next() {
